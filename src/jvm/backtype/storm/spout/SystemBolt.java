...
public class SystemBolt implements IBolt {
    ...
    public void prepare(final Map stormConf, TopologyContext context, OutputCollector collector) {
        ...
        //       topology % uptime = s/(T_1-T_0)
        //       sum over workers 'W'(
        //          sum over all metric data reported between T_0 to T_1(
        //               topologyPartialUptimeSecs for data point for W
        //           ) / (T_1 - T_0)))
        // Even if the number of workers change over time the value is still correct.
