            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.num_executors = new HashMap<String,Integer>(2*_map432.size);
                String _key433;
                int _val434;
                for (int _i435 = 0; _i435 < _map432.size; ++_i435)
                {
                  _key433 = iprot.readString();
                  _val434 = iprot.readI32();
                  struct.num_executors.put(_key433, _val434);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.num_executors != null) {
        if (struct.is_set_num_executors()) {
          oprot.writeFieldBegin(NUM_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter436 : struct.num_executors.entrySet())
            {
      ...
      if (struct.is_set_num_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter437 : struct.num_executors.entrySet())
          {
            oprot.writeString(_iter437.getKey());
            oprot.writeI32(_iter437.getValue());
          }
        }
      }
    }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.num_executors = new HashMap<String,Integer>(2*_map438.size);
          String _key439;
          int _val440;
          for (int _i441 = 0; _i441 < _map438.size; ++_i441)
          {
            ...
            struct.num_executors.put(_key439, _val440);
          }
        }
        struct.set_num_executors_isSet(true);
      }
