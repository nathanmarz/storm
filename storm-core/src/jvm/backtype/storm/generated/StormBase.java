...
public class StormBase implements org.apache.thrift.TBase<StormBase, StormBase._Fields>, java.io.Serializable, Cloneable, Comparable<StormBase> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_executors = new HashMap<String,Integer>(2*_map532.size);
                String _key533;
                int _val534;
                for (int _i535 = 0; _i535 < _map532.size; ++_i535)
                {
                  ...
                  struct.component_executors.put(_key533, _val534);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.component_executors != null) {
        if (struct.is_set_component_executors()) {
          oprot.writeFieldBegin(COMPONENT_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter536 : struct.component_executors.entrySet())
            {
              oprot.writeString(_iter536.getKey());
              oprot.writeI32(_iter536.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class StormBaseTupleScheme extends TupleScheme<StormBase> {
      ...
      if (struct.is_set_component_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter537 : struct.component_executors.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StormBase struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map538 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.component_executors = new HashMap<String,Integer>(2*_map538.size);
          String _key539;
          int _val540;
          for (int _i541 = 0; _i541 < _map538.size; ++_i541)
          {
            ...
            struct.component_executors.put(_key539, _val540);
          }
        }
        struct.set_component_executors_isSet(true);
      }
