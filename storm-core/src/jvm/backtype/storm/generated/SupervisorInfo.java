...
public class SupervisorInfo implements org.apache.thrift.TBase<SupervisorInfo, SupervisorInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorInfo> {
      ...
      if (struct.used_ports != null) {
        if (struct.is_set_used_ports()) {
          oprot.writeFieldBegin(USED_PORTS_FIELD_DESC);
          {
            ...
            for (long _iter462 : struct.used_ports)
            {
              oprot.writeI64(_iter462);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.scheduler_meta != null) {
        if (struct.is_set_scheduler_meta()) {
          oprot.writeFieldBegin(SCHEDULER_META_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter464 : struct.scheduler_meta.entrySet())
            {
  ...
  private static class SupervisorInfoTupleScheme extends TupleScheme<SupervisorInfo> {
      ...
      if (struct.is_set_used_ports()) {
        {
          ...
          for (long _iter465 : struct.used_ports)
          {
      ...
      if (struct.is_set_meta()) {
        {
          ...
          for (long _iter466 : struct.meta)
          {
            oprot.writeI64(_iter466);
          }
        }
      }
      if (struct.is_set_scheduler_meta()) {
        {
          ...
          for (Map.Entry<String, String> _iter467 : struct.scheduler_meta.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SupervisorInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list468 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.used_ports = new ArrayList<Long>(_list468.size);
          long _elem469;
          for (int _i470 = 0; _i470 < _list468.size; ++_i470)
          {
            _elem469 = iprot.readI64();
            struct.used_ports.add(_elem469);
          }
        }
        struct.set_used_ports_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list471 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.meta = new ArrayList<Long>(_list471.size);
          long _elem472;
          for (int _i473 = 0; _i473 < _list471.size; ++_i473)
          {
            _elem472 = iprot.readI64();
            struct.meta.add(_elem472);
          }
        }
        struct.set_meta_isSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.scheduler_meta = new HashMap<String,String>(2*_map474.size);
          String _key475;
          String _val476;
          for (int _i477 = 0; _i477 < _map474.size; ++_i477)
          {
            ...
            struct.scheduler_meta.put(_key475, _val476);
          }
        }
        struct.set_scheduler_meta_isSet(true);
      }
